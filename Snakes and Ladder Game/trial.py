...
def game():
    ...
    def player1_position(number, PLAYER1_POS):
    ...
    def player2_position(number, PLAYER2_POS, PLAYER2_POS_FIX):
        ...
        return PLAYER2_POS, PLAYER2_POS_FIX
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN and pygame.mouse.get_pos()[0] >= DICE_POS[0] and pygame.mouse.get_pos()[1] >= DICE_POS[1] and pygame.mouse.get_pos()[0] < 800 and pygame.mouse.get_pos()[1] < 700:
                ...
                if TURN % 2 == 0 and number != 0 and key == 1:
                    PLAYER1_POS = player1_position(number, PLAYER1_POS)
                elif TURN % 2 != 0 and number != 0 and key1 == 1:
                    PLAYER2_POS, PLAYER2_POS_FIX = player2_position(number, PLAYER2_POS, PLAYER2_POS_FIX)
